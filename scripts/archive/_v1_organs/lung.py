# DEPRECATED: 本文件已被 organs/lung/signal_layer.py 取代，保留仅为向后兼容。
# 实际生效代码见 organs/lung/signal_layer.py
...
class LungAgent(OrganBase):
    ...
    async def _handle_collect_health(self, signal: Signal) -> None:
    ...
    async def _handle_organ_heartbeat(self, signal: Signal) -> None:
        """v1.43: 被动跟踪器官心跳"""
        import time as _time
