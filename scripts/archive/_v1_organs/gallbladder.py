# DEPRECATED: 本文件已被 organs/gallbladder/signal_layer.py 取代，保留仅为向后兼容。
# 实际生效代码见 organs/gallbladder/signal_layer.py
...
class GallbladderAgent(OrganBase):
    ...
    async def _handle_decide(self, signal: Signal) -> None:
        """接收大脑发来的查询 → 决策路由"""
